...
//import testFunction from './testactions';
...
class OperationView extends Component {
  ...
  renderStateRow(operation, mostRelevantStatement, allOfTheseStatements, navigate, stateDef, testActions) {
   ...
   // const stateCount = allOfTheseStatements.length;
    ...
    if (stateToDisplay.timeType === 'ACTUAL') {
      ...
      //testStateCount = stateCount => {this.props.testactions(stateCount)}
    }
    else {
...
const mapDispatchToProps = dispatch => ({
  //testactions: data => dispatch(testActions(data))
})

export default connect(mapStateToProps, mapDispatchToProps)(OperationView);
